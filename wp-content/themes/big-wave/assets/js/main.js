...
hyper.modules.push(__webpack_require__(6));
hyper.modules.push(__webpack_require__(7));
hyper.modules.push(__webpack_require__(8));
hyper.modules.push(__webpack_require__(10));
...
var global = {
  ...
  parallaxTop: function () {
    var scrollTop = $('body').scrollTop();
    var topArea = $('.top-area.parallax .cover-area');
    var parallaxSpeed = .5;
    if (scrollTop > 0) {
